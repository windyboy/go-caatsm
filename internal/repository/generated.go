// Package repository also contains GraphQL client code generated by genqlient.
// This file (`generated.go`) includes the types and functions necessary to
// interact with the GraphQL schema defined in `genqlient.graphql`, specifically
// for mutations like `newMessage`.
//
